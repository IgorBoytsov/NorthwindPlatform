...
namespace NorthwindPlatform.Bff.Workstation.Infrastructure.Helpers
{
    public static class SqlLoader
    {
        private const string BaseNamespace = "NorthwindPlatform.Bff.Workstation.Infrastructure.Repositories";
        private const string DefaultFolderName = "Queries";
