...
namespace NorthwindPlatform.Staff.Service.Infrastructure.PostgreSQL.Helpers;

public static class SqlLoader
{
    private const string BaseNamespace = "NorthwindPlatform.Staff.Service.Infrastructure.PostgreSQL.Repositories";
